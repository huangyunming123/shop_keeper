...
if __name__ == '__main__':
    beg_m3 = AIClients.get_bge_m3_client()
    result =  generate_bge_m3_hybrid_vectors(beg_m3,["RS-12数字万用表","华为擎云940"])

    dense_1 = result["dense"][0]
    dense_2 = result["dense"][1]

    sparse_1 = result["sparse"][0]
    sparse_2 = result["sparse"][1]